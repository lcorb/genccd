function format(title, body, subtitle) {
	return `<!DOCTYPE html>
    ...
    <body width="100%" style="margin: 0; padding: 0 !important; background: #f3f3f5; mso-line-height-rule: exactly;">
        ...
        <![endif]-->
            ...
            <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: sans-serif;">
                Your NCCD data for the year is ready to be completed.
            </div>
                            ...
                            <table align="left" border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                ...
                                <tr>
                                    <td style="padding-bottom: 10px; font-size: 12px; line-height: 15px; font-family: arial, sans-serif; color: #9199A1; text-align: center;">
                                        For more information, please contact <a href="mailto:dkeen27@eq.edu.au">David Keenan</a>.
                                    </td>
                                </tr>
